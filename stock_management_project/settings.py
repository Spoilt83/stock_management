...
SECRET_KEY = 'django-insecure-+=+0u#9rmhklyeb151f61a#_9uidy%1crp-spgnttl16gnf^i6'
...
CELERY_BEAT_SCHEDULE = {
    'verify-products': {
        'task': 'stock.tasks.verify-products',
        'schedule': crontab(minute=0, hour=0, day_of_week='*'),  # Run daily at midnight
    },
}
